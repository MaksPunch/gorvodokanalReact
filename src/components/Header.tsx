...
const Header = () => {
    ...
    return (
        <header className="py-4 relative header">
            <div className="header-wrapper flex items-center justify-between relative mx-auto">
                <div className="flex items-center justify-center gap-10">
                    ...
                    <Link
                        className={classNames("menu-item", pathname === HOME_ROUTE ? "active-page" : "")}
                        to={HOME_ROUTE}
                    ...
                    {role === 'ADMIN' && !pathname.startsWith('/admin')
                        ?
                        <Link
                            className={classNames("menu-item", pathname === COURSES_PAGE_ADMIN_ROUTE ? "active-page" : "")}
                            to={COURSES_PAGE_ADMIN_ROUTE}
                            data-href={COURSES_PAGE_ADMIN_ROUTE}
                        >Панель администратора</Link>
                        : ""}
