...
const Notifications = () => {
    ...
    return (
        <div className="relative" ref={notificationsRef}>
            ...
            <div
                className={classNames("flex flex-col absolute gap-2 shadow-[0_0_50px_-10px_rgb(0,0,0,0.15)] py-3 px-3 bg-white w-80 h-80 top-12 left-1/2 -translate-x-1/2 transition-opacity z-20 rounded", notificationsOpen ? "opacity-100" : "opacity-0 -translate-y-96")}
            ...
            >
                <div className="flex justify-between items-center border-b pb-2">
                    ...
                    <div className="flex gap-2 items-center">
                        ...
                        <XMarkIcon className="size-7 cursor-pointer hover:bg-blue-300 rounded transition-colors"/>
                    </div>
                </div>
