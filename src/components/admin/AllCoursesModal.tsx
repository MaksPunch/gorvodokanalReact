...
const AllCoursesModal = ({editHeader, setModalOpen, modalOpen}: PropTypes) => {
    return (
        <div className={classNames("fixed w-full h-full bg-black bg-opacity-50 flex items-center justify-center top-0 left-0 z-50", modalOpen ? "flex" : "hidden")}>
            <div className="bg-white w-3/4 p-7 rounded">
                <div className="flex justify-between items-center">
                    <span className="text-xl font-medium">Редактирование курсов {editHeader}</span>
                    <XMarkIcon
