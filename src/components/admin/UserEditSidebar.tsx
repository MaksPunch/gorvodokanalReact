...
const UserEditSidebar = ({sidebarOpen, setSidebarOpen}: {sidebarOpen: boolean, setSidebarOpen: ((open: boolean) => void)}) => {
    return (
        <div
        ...
        >
            ...
            <MySelect name="departmentFilter" label="Фильтр по отделу" items={filterOptions}/>
            ...
            <div className="flex flex-col gap-4 mt-7">
                <div className="flex justify-between items-center rounded border border-black border-opacity-50 rounded p-2.5">
                    <div className="flex gap-7 items-center">
                        <img src={userImg} alt="Иван Иванов" className="size-11 rounded-full"/>
