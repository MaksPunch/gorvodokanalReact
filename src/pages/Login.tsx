...
const Login = () => {
  ...
  useEffect(() => {
    document.title =
      "Вход | Система дистанцинного обучения ВологдаГорВодоканал";
  }, []);
    ...
    <div className="main-wrapper">
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <img className="mx-auto" src={logo_login} alt="Горводоканал" />
          ...
          >
            ...
            <div>
              ...
              <div className="mt-2 flex flex-col gap-1">
                ...
                />
                {passwordMessage ? (
                  <p className="text-red-500 text-xs">{passwordMessage}</p>
                ) : (
                  ""
                )}
              </div>
