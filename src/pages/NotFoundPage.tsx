...
const NotFoundPage = () => {
    ...
    return (
        <div className="main-wrapper text-center">
            ...
            <p className="text-stone-500 font-medium text-2xl mb-10">К сожалению, такой страницы нет!</p>
            <MyButton onClick={() => navigate(userId ? HOME_ROUTE : LOGIN_ROUTE)}>Вернуться на главную</MyButton>
        </div>
    );
};
