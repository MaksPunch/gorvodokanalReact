...
const SectionPageAdmin = () => {
    ...
    return (
        <div className="main-wrapper flex flex-col gap-7 pb-16">
            ...
            <MyInput name={"name"} type={"text"} label={"Название темы"} value={name}
            ...
            <div className="CKEditor">
                <CKEditor
                    ...
                    onReady={newEditor => {
                        newEditor.plugins.get('FileRepository').createUploadAdapter = function (loader) {
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-7 items-center">
                    ...
                    <button
                        className="bg-red-600 px-5 py-2 text-sm text-white rounded hover:bg-red-700 transition-colors"
                    >
                        Отмена
                    </button>
                </div>
