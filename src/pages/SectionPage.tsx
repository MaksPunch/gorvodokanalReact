...
const SectionPage = () => {
  ...
  const section = useAppSelector((state) =>
    selectSectionById(state, Number(id)),
  );
  ...
  return (
    <div className="main-wrapper flex flex-col gap-12">
      ...
      <Link
        to={SECTION_PAGE_ROUTE + "/" + id + TEST_PAGE_ROUTE + "/1"}
        className="self-end text-sm px-4 py-2 rounded border border-black border-opacity-25 flex justify-center items-center gap-2.5"
      >
