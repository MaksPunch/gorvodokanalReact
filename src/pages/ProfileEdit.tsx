      ...
      <div className="flex flex-col gap-3.5">
        ...
        <div className="flex gap-7 items-center">
          ...
          <div className="flex flex-col gap-2.5 items-start">
            ...
            <p className="text-opacity-75 text-black text-xs font-medium">
              JPG, GIF или PNG. До 1Мбайта.
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-7 self-end">
          ...
          <button className="px-2.5 py-2 bg-white rounded border border-black border-opacity-50 hover:bg-gray-100 transition-colors">
            Отмена
          </button>
        </div>
      </div>
