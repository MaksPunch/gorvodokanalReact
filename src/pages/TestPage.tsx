...
import {fetchAnswers, selectAnswer, selectAnswersByQuestionId} from "../store/reducers/answerSlice.ts";
import {
    fetchQuestions,
    selectQuestionById,
...
const TestPage = () => {
    ...
    const answersForQuestion = useAppSelector(selectAnswersByQuestionId(Number(questionId)));
